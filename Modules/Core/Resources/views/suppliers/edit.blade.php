        ...
        <form method="POST" action="{{ route('suppliers.update', $supplier) }}" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="address" rows="2"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300">{{ old('address', $supplier->address) }}</textarea>
            </div>
            ...
            <div class="flex items-center gap-2">
                ...
                <label for="is_active" class="text-sm font-medium text-gray-700">Supplier Aktif</label>
            </div>
